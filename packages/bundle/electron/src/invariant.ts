/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-electron`.
 * @module @deepseek-ai/dsh-electron/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@deepseek-ai/dsh-electron'

/** Cordis companion plugin name. */
export const name = 'electron-bundle-invariant'
