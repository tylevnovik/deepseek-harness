...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/host/electron': { kind: 'none', reason: 'The inert Electron carrier stub routes no request and registers nothing model-facing.' },
  ...
  'packages/bundle/electron': { kind: 'indirect', reason: 'The bundle is a patch-list carrier that only reconfigures carrier and surface rows; each inserted row\'s package owns its model-facing behavior.' },
